            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="small ml-1 d-md-down-none">段嗣国</span>
                    </a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="${basePath}/manage/setting/saveVoteModify.htm" method="post" enctype="multipart/form-data">
                                    <div class="row">

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="normal-input" class="form-control-label">标题</label>
                                                <input id="normal-input" class="form-control" value="${vote.voteTittle}" name="voteTittle">
                                            </div>
                                        </div>
                                    ...
                                    <input id="ts2" type="hidden" name="id" value="${voteInfo.id}">
                                </form>
                            </div>
                        </div>
                    </div>
