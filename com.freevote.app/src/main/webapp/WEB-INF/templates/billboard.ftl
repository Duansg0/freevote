                    ...
                    <div class="layui-col-md6">
                        <div class="layui-card">
                            <div class="layui-card-header">
                                <i class="layui-icon layui-icon-note" style="font-size: 16px; color: black;"><b>榜单</b></i>
                            </div>
                            <#list billboards as b>
                                <div class="layui-card-body" onclick="voteAdd(${b.userCode})">
                                    ...
                                    <b>【${b.userCode}号】${b.userName}</b><br>票数
                                    <span class="layui-badge">${b.userVoteCount}</span>
                                    <div style="text-align:right ;">${b_index + 1}</div>
                                    <hr />
                                </div>
                            </#list>
                        </div>
